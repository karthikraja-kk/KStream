...
class WatchHistoryFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View =
        inflater.inflate(R.layout.fragment_watch_history, container, false)
    ...
    private fun render(state: WatchHistoryUiState) {
    ...
    private fun confirmDelete() {
        ...
        AppConfirmDialog.show(
            ...
            message = "Delete $count movies from watch history? This won't unlike them.",
